...
-- Tiempo de generación: 14-05-2020 a las 20:09:13
...
CREATE TABLE `restaurants` (
  ...
  `tipus_cuina` varchar(255) COLLATE utf8_bin NOT NULL,
...
(11, 'El asador argentino', 'Asador dedicat al menjar argentí', 0, 0, '', '', 0, '', 1),
...
(18, 'dsagfddd', 'Fuma\'t els porrilos a gust', 0, 0, '', '', 0, '', 11),
(19, 'fdsafads', 'dfasfadsfasd', 0, 0, '', '', 0, '', 11),
(20, 'hola', 'qweqwe', 5, 5, 'mediterrania', 'dassaf', 999999999, 'fdsfdsfdsf', 11);
...
(11, 'Pere', 'peredirtbike@gmail.com', NULL, '$2y$10$l8uP/dJBUQtRChjz5s/34etJWudWfFcQYTBsYIa5jknpvYlsr.LMO', NULL, '2020-05-12 18:27:25', '2020-05-12 18:27:25', 1, 1, '47747322N', 'Garcia', 'home', '1998-11-03', 'default.jpg');
